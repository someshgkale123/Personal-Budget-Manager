...
export class NovemberComponent implements OnInit {
  ...
  constructor(public authservice:AuthService, public fireservice:AngularFirestore, private router:Router, public nov:NovemberService) { }
  ...
  ngOnInit(): void {
      ...
      this.nov.getbudget().subscribe(data=>
        {
  ...
  createrecord()
  {
    ...
    this.nov.createbudget(Value).then(res=>{
      this.Title="";
  ...
  updatebudget(updatedata)
  {
    ...
    this.nov.update_data(updatedata.id,data);
