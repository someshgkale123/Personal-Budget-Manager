...
import {JanserviceService} from '../services/janservice.service'
...
export class JanuaryComponent implements OnInit {
  ...
  constructor(public dash:DashboardComponent,public authservice:AuthService, public fireservice:AngularFirestore, private router:Router, public jans:JanserviceService) { }
  ...
  ngOnInit(): void {
      ...
      this.jans.getbudget().subscribe(data=>
        {
  ...
  createrecord()
  {
    ...
    this.jans.createbudget(Value).then(res=>{
      this.Title="";
  ...
  updatebudget(updatedata)
  {
    ...
    this.jans.update_data(updatedata.id,data);
  ...
  {
    this.jans.deletebudget(budget_id);
    location.reload();
  }
